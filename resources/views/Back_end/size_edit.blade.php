...
<div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់កែប្រែទំហំមែនទេ?
            </div>
            <div class="card-body">
            <form method="POST" action="{{ route('Back_end.size_update', $sizes->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">ទំហំ</label>
                    <input value="{{$sizes->text_size}}" type="text" name="text_size" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
