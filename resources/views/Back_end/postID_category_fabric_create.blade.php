...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់បញ្ចូលការបង្ហោះមែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.postID_category_fabric_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ខ្លឹមសារ</label>
                        <input type="text" name="caption" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">រូបភាព</label>
                        <input type="file" name="image" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp" onchange="previewImage(event)">
                        <img class="mt-2" id="preview" src="#" alt="" height="150" width="150">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">តម្លៃ</label>
                        <input type="number" step="0.01"  placeholder="$.$$" name="price" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ម៉ាក</label>
                        <input type="text" name="brand" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                        ...
                        <!--<input type="text" name="clothe_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">-->
                            ...
                            <select class="form-control input_search" name="category_clothe_id" id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                @foreach ($category_clothes as $st)
                                    <option name="category_clothe_id" value="{{$st->id}}">{{$st->text_clothes}}</option>
                                @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control input_search" name="category_fabric_id" id="exampleInputEmail1" aria-describedby="emailHelp">
                            ...
                            <option name="category_fabric_id" value="{{$category_fabrics->id}}">{{$category_fabrics->text_fabrics}}</option>
