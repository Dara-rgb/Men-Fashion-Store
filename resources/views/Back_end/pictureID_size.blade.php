...
<body>
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <ul class="list-unstyled text-center w-100 mt-1 ">
            ...
            <li class="type_bg_data"><a class="type_text_data text-decoration-none d-block py-3 " href="{{route('Back_end.size')}}">ទំហំ</a></li>
        ...
        <div class="container-fluid w-75 mr-0" >
            ...
            <div class="row mb-2 bg-data sticky-top w-100">
                <div class="col-12">
                    ...
                    <a href="{{route('Back_end.pictureID_size_create',['id' => $sizes->id ])}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.pictureID_size_alldestroy',['id' => $sizes->id ])}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                        ...
                        <tbody>
                            ...
                            @foreach ($pictures as $st)
                                ...
                                <tr class="table-text-color ">
                                    <th scope="row" class=" text-center table-color"><p class="mt-0">{{$id++}}</p></th>
                                    @php
                                    ...
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.pictureID_size_edit',['id' => $st->id ,'Id' => $st->post_id ,'ID' => $st->contact_id , 'sid' => $st->size_id])}}"><button class="btn btn-sm btn-success  ">កែប្រែ</button></a>
                                    </td>
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.pictureID_size_destroy',['id' => $st->id ,'Id' => $st->post_id ,'ID' => $st->contact_id , 'sid' => $st->size_id])}}"><button class="btn btn-sm btn-danger  ">លុប</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
