    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                តើអ្នកពិតជាចង់លុបប្រភេទសម្លៀកបំពាក់មែនទេ?
            </div>
            <div class="card-body">
            <form method="POST" action="{{ route('Back_end.category_clothe_delete', $category_clothes->id) }}">
                @csrf 
                @method('DELETE')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">ប្រភេទសម្លៀកបំពាក់</label>
                    <input value="{{$category_clothes->text_clothes}}" type="text" name="text" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
