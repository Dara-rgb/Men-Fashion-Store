...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់បញ្ចូលសម្លៀកបំពាក់មែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.clothe_store') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">សម្លៀកបំពាក់</label>
                        <input type="text" name="text" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
