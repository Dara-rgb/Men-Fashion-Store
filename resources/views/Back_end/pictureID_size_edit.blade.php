...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់កែប្រែរូបភាពមែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.pictureID_size_update', $pictures->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">រូបភាព</label>
                        <input type="file" name="image_picture[]" class="form-control input_search" id="images" aria-describedby="emailHelp" >
                        ...
                        @endforeach
                        <p style="float:right; margin-top:-41.75px;">រូបថ្មី</p>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="post_id" class="form-control input_search" id="post-select" onchange="updateImage()">
                            ...
                            <p style="float:right; margin-top:-41.75px;">រូបថ្មី</p>
                            <img style="float:right;" class="mt-2" id="post-image" src="" alt="No image selected" width="150" height="150">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="contact_id" class="form-control input_search" id="contact-select" onchange="contactImage()">
                            ...
                            <p style="float:right; margin-top:-41.75px;">រូបថ្មី</p>
                            <img style="float:right;" class="mt-2" id="contact-image" src="" alt="No image selected" width="150" height="150">
