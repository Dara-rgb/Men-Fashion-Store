...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់បញ្ចូលប្រភេទសម្លៀកបំពាក់មែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.category_clothe_store') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ប្រភេទសម្លៀកបំពាក់</label>
                        <input type="text" name="text_clothes" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
