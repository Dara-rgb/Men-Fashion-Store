...
<body>
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <ul class="list-unstyled text-center w-100 mt-1 ">
            ...
            <form class="form-inline mb-5 mt-4 sticky-top bg_search" action="{{ route('Back_end.search_category_fabric') }}" method="GET">
        ...
        <div class="container-fluid w-75 mr-0">
            ...
            <div class="row mb-2 sticky-top bg-data">
                <div class="col-12">
                    <h2 class="mt-2 mb-3 dark">បញ្ជីសាច់ក្រណាត់</h2>
                    ...
                    <a href="{{route('Back_end.category_fabric_create')}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.category_fabric_alldestroy')}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                </div>
            </div>
            <div class="row mt-1">
                @if (session('success'))
            ...
            <table class="table table-bordered mt-1 ">
                <thead class="sticky-top table-bg-color " style="top: 99.30px;">
                    <tr>
                        ...
                        <th class="table-color-thead-r text-center" scope="col">ប្រភេទសាច់ក្រណាត់</th>
