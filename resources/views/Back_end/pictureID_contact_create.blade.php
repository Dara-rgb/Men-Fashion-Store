...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់បញ្ចូលរូបភាពមែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.pictureID_contact_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">រូបភាព</label>
                        <input type="file" name="image_picture[]" class="form-control input_search" id="images" aria-describedby="emailHelp" multiple>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="post_id" class="form-control input_search" id="post-select" onchange="updateImage()">
                            <option name="post_id" value="">Select a Caption</option>
                            @foreach ($post as $st)
                            ...
                            <img class="mt-3" id="post-image" src="" alt="No image selected" width="200" height="200">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="contact_id" class="form-control input_search" id="contact-select" onchange="contactImage()">
                                ...
                                <option name="contact_id" value="{{ $contact->id }}">{{ $contact->name_contact }}</option>
                            
                        </select>
                        
                            
                            <img class="mt-3" id="contact-image" src="{{ asset('storage/' . $contact->image_contact) }}" alt="" width="200" height="200">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="size_id" class="form-control input_search" >
                            <option name="size_id" value="">Select a Size</option>
                            @foreach ($sizes as $st)
