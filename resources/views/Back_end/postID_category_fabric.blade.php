...
<body>
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <ul class="list-unstyled text-center w-100 mt-1 ">
            ...
            <li class="type_bg_data"><a class="type_text_data text-decoration-none d-block py-3 " href="{{route('Back_end.category_fabric')}}">ប្រភេទសាច់ក្រណាត់</a></li>
        ...
        <div class="container-fluid w-75 mr-0">
            ...
            <div class="row mb-2 sticky-top bg-data">
                <div class="col-12">
                    ...
                    <a href="{{route('Back_end.postID_category_fabric_create',['id' => $category_fabrics->id ])}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.postID_category_fabric_alldestroy',['id' => $category_fabrics->id ])}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                            ...
                            @foreach ($post as $st)
                                ...
                                <tr class="table-text-color">
                                    ...
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.postID_category_fabric_edit',['id' => $st->id ,'Id' => $st->category_clothe_id ,'ID' => $st->category_fabric_id])}}"><button class="btn btn-sm btn-success  ">កែប្រែ</button></a>
                                    </td>
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.postID_category_fabric_destroy',['id' => $st->id ,'Id' => $st->category_clothe_id ,'ID' => $st->category_fabric_id])}}"><button class="btn btn-sm btn-danger  ">លុប</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
