...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់បញ្ចូលអក្សររត់មែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.announcement_store') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">អក្សររត់</label>
                        <input type="text" name="content" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
