...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់លុបការបង្ហោះមែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.postID_category_fabric_delete' , $post->id) }}" method="post" enctype="multipart/form-data">
                    @csrf 
                    @method('DELETE')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ asset('storage/' . $post->image) }}" type="file" name="image" class="form-control mb-2 input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
