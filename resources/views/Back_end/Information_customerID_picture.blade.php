...
<body>
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <ul class="list-unstyled text-center w-100 mt-1 ">
            ...
            <li class="type_bg_data"><a class="type_text_data text-decoration-none d-block py-3 " href="{{route('Back_end.picture')}}">រូបភាព</a></li>
        ...
        <div class="container-fluid mr-0 w-75" >
            ...
            <div class="row mb-2 sticky-top bg-data">
                <div class="col-12">
                    ...
                    <a href="{{route('Back_end.Information_customerID_alldestroy_picture',['id' => $pictures->id ])}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                            ...
                            @foreach ($information_customers as $st)
                                ...
                                <tr class="table-text-color ">
                                    ...
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.Information_customerID_edit_picture',['id' => $st->id ,'ID' => $st->picture_id])}}"><button class="btn btn-sm btn-success  ">កែប្រែ</button></a>
                                    </td>
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.Information_customerID_destroy_picture',['id' => $st->id ,'ID' => $st->picture_id])}}"><button class="btn btn-sm btn-danger  ">លុប</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
