...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('Back_end.pictureID_size_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="contact_id" class="form-control input_search" id="contact-select" onchange="contactImage()">
                            <option name="contact_id" value="">Select a Caption</option>
                            ...
                            <img class="mt-3" id="contact-image" src="" alt="No image selected" width="200" height="200">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="size_id" class="form-control input_search" >
                                ...
                                <option name="size_id" value="{{ $sizes->id }}">{{ $sizes->text_size }}</option>
