        ...
        <div class="container-fluid mr-0 w-75" >
            ...
            <div class="row mb-2 sticky-top bg-data">
                <div class="col-12">
                    ...
                    <a href="{{route('Back_end.post_create')}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.post_alldestroy')}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                </div>
            </div>
            <div class="row mt-1">
                @if (session('success'))
