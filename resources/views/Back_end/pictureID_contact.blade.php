        ...
        <div class="container-fluid w-75 mr-0" >
            ...
            <div class="row mb-2 bg-data sticky-top w-100">
                <div class="col-12">
                    ...
                    <a href="{{route('Back_end.pictureID_contact_create',['id' => $contact->id ])}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.pictureID_contact_alldestroy',['id' => $contact->id ])}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                            ...
                            @foreach ($pictures as $st)
                                ...
                                <tr class="table-text-color ">
                                    ...
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.pictureID_contact_edit',['id' => $st->id ,'Id' => $st->post_id ,'ID' => $st->contact_id ,'sid' => $st->size_id])}}"><button class="btn btn-sm btn-success  ">កែប្រែ</button></a>
                                    </td>
                                    <td class="text-center table-color">
                                        <a href="{{route('Back_end.pictureID_contact_destroy',['id' => $st->id ,'Id' => $st->post_id ,'ID' => $st->contact_id ,'sid' => $st->size_id])}}"><button class="btn btn-sm btn-danger  ">លុប</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
