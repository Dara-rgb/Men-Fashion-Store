    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                តើអ្នកពិតជាចង់លុបអក្សររត់មែនទេមែនទេ?
            </div>
            <div class="card-body">
            <form method="POST" action="{{ route('Back_end.announcement_delete', $announcements->id) }}">
                @csrf 
                @method('DELETE')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">អក្សររត់</label>
                    <input value="{{$announcements->content}}" type="text" name="content" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
