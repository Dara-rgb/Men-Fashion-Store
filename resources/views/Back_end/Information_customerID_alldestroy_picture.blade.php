    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                តើអ្នកពិតជាចង់លុបព័ត៍មានអតិថិជនទាំងអស់មែនទេ?
            </div>
            <div class="card-body">
            <form method="POST" action="{{ route('Back_end.Information_customerID_alldelete_picture', $information_customers->first()->picture_id ?? '0') }}">
                @csrf 
                @method('DELETE')
