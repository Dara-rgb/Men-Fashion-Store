    ...
    <div class="container-fluid w-75 mr-0 ">
        ...
        <div class="row mb-2 sticky-top bg-data">
            <div class="col-12">
                ...
                <a href="{{route('Back_end.category_clothe_create')}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                <a href="{{route('Back_end.category_clothe_alldestroy')}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
