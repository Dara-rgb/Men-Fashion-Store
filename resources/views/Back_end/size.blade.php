...
<body>
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <ul class="list-unstyled text-center w-100 mt-1 ">
            ...
            <form class="form-inline mb-5 mt-4 sticky-top bg_search" action="{{ route('Back_end.search_size') }}" method="GET">
        ...
        <div class="container-fluid w-75 mr-0 ">
            ...
            <div class="row mb-2 sticky-top bg-data ">
                <div class="col-12">
                    <h2 class="mt-2 mb-3 dark">បញ្ជីទំហំ</h2>
                    ...
                    <a href="{{route('Back_end.size_create')}}" class="text-decoration-none"><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.size_alldestroy')}}" class="text-decoration-none"><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                </div>
            </div>
            <div class="row mt-1">
                @if (session('success'))
                ...
                <tbody>
                    ...
                    @foreach ($sizes as $st)
                        ...
                        <tr class="table-text-color">
                            ...
                            <td class="table-color text-center"> <a class=" text-decoration-none" href="{{route('Back_end.pictureID_size',['id' => $st->id])}}">{{$st->text_size}}</a> </td>
