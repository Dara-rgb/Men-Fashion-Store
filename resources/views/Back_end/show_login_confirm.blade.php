...
<head>
    ...
    <title>Login-Confirm - Men Fashion Store</title>
...
<body>
    <div class="box">
        ...
        <form action="{{ route('Back_end.login_confirm') }}" method="POST">
            @csrf
            
            <!-- ១. ប្រអប់ឈ្មោះ -->
            <div class="form-group">
                <label><i class="fas fa-user-shield"></i> ឈ្មោះអ្នកប្រើប្រាស់</label>
                <input class="four_corner" type="text" name="name" required placeholder="បញ្ចូលឈ្មោះ" value="{{ old('name') }}" autofocus>
            </div>
            ...
            <button type="submit" class="btn">ចូលកែប្រែព័ត៌មានសម្ងាត់</button>
