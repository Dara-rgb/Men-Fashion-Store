...
<body>
    <div class="container mt-5">
        ...
        <div class="card mt-3 mb-3">
            <div class="card-header">
                តើអ្នកចង់កែប្រែព័ត៌មានអតិថិជនមែនទេ?
            </div>
            <div class="card-body">
                <form action="{{ route('Back_end.Information_customerID_update_picture' , $information_customers->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
