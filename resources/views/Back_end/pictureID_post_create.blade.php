...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('Back_end.pictureID_post_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="post_id" class="form-control input_search" id="post-select" onchange="updateImage()">
                                ...
                                <option name="post_id" value="{{ $post->id }}">{{ $post->caption }}</option>
                            
                        </select>
                        
                            
                            <img class="mt-3" id="post-image" src="{{ asset('storage/' . $post->image) }}" alt="" width="200" height="200">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="contact_id" class="form-control input_search" id="contact-select" onchange="contactImage()">
                            <option name="contact_id" value="">Select a Contact</option>
