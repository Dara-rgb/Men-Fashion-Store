...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('Back_end.category_clotheID_update' , $category_clothes->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ប្រភេទសម្លៀកបំពាក់</label>
                        <input value="{{$category_clothes->text_clothes}}" type="text" name="text_clothes" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-control input_search" name="clothe_id" id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <option name="clothe_id" value="{{$clothes->id}}">{{$clothes->text}}</option>
