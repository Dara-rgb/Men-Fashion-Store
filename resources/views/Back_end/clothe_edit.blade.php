...
<div class="container mt-5">
        <div class="card">
            ...
            តើអ្នកពិតជាចង់កែប្រែសម្លៀកបំពាក់មែនទេ?
            </div>
            <div class="card-body">
            <form method="POST" action="{{ route('Back_end.clothe_update', $clothes->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">សម្លៀកបំពាក់</label>
                    <input value="{{$clothes->text}}" type="text" name="text" class="form-control input_search" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
