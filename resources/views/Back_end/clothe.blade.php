    ...
    <div class="container-fluid bg_secondary w-25 position-fixed  sidebar-menu ">
        ...
        <div class="container-fluid w-75 mr-0 ">
            ...
            <div class="row mb-2 sticky-top bg-data ">
                <div class="col-12">
                    <h2 class="mt-2 mb-3 dark">បញ្ជីសម្លៀកបំពាក់</h2>
                    ...
                    <a href="{{route('Back_end.clothe_create')}}" class="text-decoration-none "><button class="btn btn-info text-btn" >បញ្ចូល</button> </a>
                    <a href="{{route('Back_end.clothe_alldestroy')}}" class="text-decoration-none "><button class="btn btn-warning text-btn" >លុបទាំងអស់</button> </a>
                </div>
            </div>
            <div class="row mt-1">
                @if (session('success'))
            ...
            <table class="table table-bordered mt-1 " >
                ...
                <tbody>
                    <p hidden>{{$id = 1;}}</p>
                    @foreach ($clothes as $st)


                        <tr class="table-text-color">
                            <th class="table-color text-center" scope="row">{{$id++}}</th>
                            <td class="table-color text-center"> <a class="text-dark text-decoration-none" href="{{route('Back_end.category_clotheID',['id' => $st->id])}}">{{$st->text}}</a> </td>
