    ...
    <div class="container-fluid">
		<div class="container mt-5 pl-0 pr-0">
			<div class="row mx-auto">
				@foreach ($clothes as $index => $st)
					<div class="col-4 pt-3 pl-0 pr-0">
						<p class="brand ml-0 mr-0 d-flex
							@if($index == 0) justify-content-start
							@elseif($index == 1) justify-content-center
							@elseif($index == 2) justify-content-end
							@endif">
							<a class="" href="{{route('Front_end.clothe',['id' => $st->id])}}">
								{{$st->text}}
							</a>
						</p>
					</div>
		...
		<div class="container p-1 ">
									...
									<div class="row ">
										<div class="col-12 p-1">
											...
											<a class="continue" href="{{route('Front_end.index_all')}}">មើលបន្ត</a>
										</div>
									</div>
                                                    ...
                                                    <a href="{{route('Front_end.picture',['id' => $st->id])}}">
                                                        <div class="post position-relative">
															<input type="checkbox" class="post-checkbox" value="{{ $st->id }}"  style="position: absolute; top: 10px; left: 10px; z-index: 10; width: 20px; height: 20px;">
																<figure>
																		<img src="https://ychsunvttdsjtwonmqpy.supabase.co/storage/v1/object/public/products/1tvSoLxKdnWncbusxPwAPku0qHZWRdk0oSgDfujV.jpg"  class="img-fluid card-img-top" alt="...">																																																							
