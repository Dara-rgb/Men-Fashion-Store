...
<body>
    <div class="navbar navbar-expand-lg navbar-light bg_secondary container-fluid sticky-top shadow-sm">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0 ml-auto " action="{{ route('Front_end.search') }}" method="GET">
		...
		<div class="container p-1 ">
									...
									<div class="row ">
										<div class="col-12 p-1">
											<p class="tag ml-0">បានស្វែងរក"{{ request('query') }}" </p>
									...
									@else
										<div class="row mb-4">
											<div class="col-12">
												<h1 class="text-center not_found">Not Found</h1>
											</div>
										</div>
									@endif
