...
<body>
	...
	<div class="container-fluid ">
		<div class="container table-container pr-0 pl-0 ">
			<div class="columns ">
				...
				<div class="column ">
					@php 
						$category_clothes
					@endphp
					<a href="{{route('Front_end.category_fabric',['ID' => $category_clothes->id,'id' => $st->id])}}">{{$st->text_fabrics}}</a>
				</div>
				@endforeach
		...
		<div class="container p-1 ">
									...
									<div class="row ">
										<div class="col-12 p-1">
											<p class="tag ml-0">{{$category_clothes->text_clothes}}</p>
